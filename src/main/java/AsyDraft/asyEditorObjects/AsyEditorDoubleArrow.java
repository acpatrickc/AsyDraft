...
public class AsyEditorDoubleArrow extends AsyEditorSegment {
	 ...
	 */
	public AsyEditorDoubleArrow(double[] start, double[] end) {
		super(start, end);
	}
	/*
	...
	public AsyObject getAsyObject(int gridwidth, int gridheight) {
		return new AsyDoubleArrow(MathUtils.toCartesian(startx, gridwidth), MathUtils.toCartesian(starty, gridheight), MathUtils.toCartesian(endx, gridwidth), MathUtils.toCartesian(endy, gridheight));
	}
	/*
