...
public class AsyEditorEndArrow extends AsyEditorSegment {
	 ...
	 */
	public AsyEditorEndArrow(double[] start, double[] end, AsyPen p) {
		super(start, end, p);
	}
	/*
	...
	public AsyObject getAsyObject(int gridwidth, int gridheight) {
		return new AsyEndArrow(MathUtils.toCartesian(startx, gridwidth), MathUtils.toCartesian(starty, gridheight), MathUtils.toCartesian(endx, gridwidth), MathUtils.toCartesian(endy, gridheight), pen);
	}
	/*
